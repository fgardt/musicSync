...
module.exports = {
  defaultInfoFile: {"settings" : {"refresh" : 600, "maxDl" : 2}, "data" : {"amount": 0, "lastUuid" : "a007", "refreshComplete" : true, "dir" : null, "lastRefresh" : 0, "activeDl" : 0, "remove" : {"total" : 0, "complete" : 0, "progress" : -1}, "download" : {"total" : 0, "complete" : 0, "progress" : -1}},"playlists" : {}},
  info: null,
  info_old: null,
  debug: false,
  ...
  downloadTrack: function(uuid, id) {
    var dir = module.exports.info.playlists[uuid].dir;
    var name = module.exports.info.playlists[uuid].all[id].name;
    ...
    var interval = setInterval(function () {
      if (!downloading) {
        if (module.exports.info.data.activeDl < module.exports.info.settings.maxDl) {
          ...
          try {   // "--embed-thumbnail", "--metadata-from-title", "'%(artist)s - %(title)s'",
            youtubedl.exec("https://www.youtube.com/watch?v=" + id, ["-x", "--audio-format", "mp3", "--audio-quality", "0", "-o", "%(title)s.%(ext)s"], {cwd: dir}, function(e, output) {
